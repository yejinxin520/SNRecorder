...
public class InfoActivity extends Activity {
	...
	private TextView uidrep,customerrep,modelrep,costrep,issuerep,solverep,backrep,warrantyrep,commentrep;
				...
				if(result==""){
					...
					try{
						...
						if(type.equals("out")){
							...
							System.out.println(model+","+uidnum+","+date+","+comment);
							...
							String issues_resolve = jsonObject.getString("issues_resolve");
							String sent_back = jsonObject.getString("sent_back");
							String warranty = jsonObject.getString("warranty");
							String comment = jsonObject.getString("comment");
							System.out.println(model+","+uid+","+customer+","+comment+","+costs
									+","+issues+","+issues_resolve+","+sent_back+","+warranty);
							uidrep.setText(uid);
			...
			public HttpUriRequest getRequestMethod() {
				...
				if(type.equals("out")){
					url = "http://192.168.0.201/mary/sellrec/api/query/"
							+selection+"/?format=json&username=tomsu&api_key=123456&id="
							+selection+"&p=0";
				}
				else if(type.equals("repair")){
